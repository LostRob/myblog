...
function show_replyform(obj) {
    ...
    obj.parentElement.getElementsByClassName('comment-submit')[0].style.display = 'block';
    obj.parentElement.getElementsByClassName('form-control')[0].focus();
...
function hidden_replyform(obj) {
    //obj.parentElement.getElementById('reply-form').style.display = 'none';
    //obj.parentElement.getElementsByClassName('reply-form').style.display = 'none';
    //obj.parentElement.getElementsByClassName('reply-form')[0].style.display = 'none'
    obj.parentElement.parentElement.parentElement.getElementsByClassName('comment-submit')[0].style.display = 'none';
}
